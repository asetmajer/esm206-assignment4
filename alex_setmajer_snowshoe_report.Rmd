---
title: "Juvenile Snowshoe Hares, 1998-2012"
...
Bonanza Creek LTER is part of the US Long Term Ecological Research Network. See more information about the site here.  The data citation and link to metadata (including variable definitions) are below.
...
EDIT ___ Count the total number of juvenile hare trappings during each year of the study, and create a finalized data visualization of the counts by year. Include a figure caption below the figure in your report. 
...
EDIT ___Then, in 3 - 4 sentences below your figure, describe major takeaways from your graph about total snowshoe hare trappings at the site. You might consider:
